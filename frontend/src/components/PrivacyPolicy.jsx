      ...
      content: [
        {
          ...
          text: "When you create an account on paisa, we collect basic registration information including your name, email address, and encrypted password credentials."
        },
        {
      ...
      <footer className="border-t border-white/10 bg-[#09090c] py-8 mt-12">
        <div className="max-w-6xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between text-xs text-paisa-textMuted gap-4">
          <div className="flex items-center gap-1 font-bold text-white">
            ...
            <span className="font-normal text-paisa-textMuted ml-2">© 2026 paisa. All rights reserved.</span>
          </div>
